...
class TryUnlock extends StatelessWidget {
  const TryUnlock({super.key});
        ...
        child: SizedBox(
          child: Column(
            ...
            children: [
              ...
              const Text(
                "L’indice qui vous permettra de vous rappeler de votre mot secret ex: La personne que j’aime le plus à Ouagadougou",
                style: TextStyle(
                  fontSize: 15.0,
                  fontWeight: FontWeight.bold,
                  color: Colors.black,
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  labelText: "Entrez votre mot secret",
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      if (secretController.text.trim().toLowerCase() ==
                          "maman") {
